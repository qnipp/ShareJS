...
(function() {
  ...
  */
  ...
  if (typeof WEB !== "undefined" && WEB !== null) {
    ...
    socketImpl = (function() {
      switch (false) {
        case BCSocket == null:
          return 'channel';
        case (typeof Meteor !== "undefined" && Meteor !== null ? Meteor.connection._stream.socket : void 0) == null:
          return 'meteor';
        case SockJS == null:
          return 'sockjs';
        default:
  ...
  console.log("socketImpl = " + socketImpl);
  ...
  Connection = (function() {
    function Connection(host, authentication) {
      ...
      console.log("socketImpl2 = " + socketImpl);
      if (socketImpl == null) {
        if (host.match(/^ws:/)) {
      ...
      this.socket = (function() {
        switch (socketImpl) {
          ...
          case 'meteor':
            return Meteor.connection._stream.socket;
          case 'sockjs':
      ...
      this.socket.onmessage = function(incoming_msg) {
        var docName, msg;
        console.log('incoming_msg', incoming_msg);
        msg = socketImpl === 'sockjs' || socketImpl === 'websocket' || socketImpl === 'meteor' ? JSON.parse(incoming_msg.data) : incoming_msg;
        if (socketImpl === 'meteor' && (msg.msg != null)) {
          return;
        }
        console.log('msg', msg);
        if (msg.auth === null) {
    ...
    Connection.prototype.send = function(data) {
      ...
      if (socketImpl === 'sockjs' || socketImpl === 'websocket' || socketImpl === 'meteor') {
